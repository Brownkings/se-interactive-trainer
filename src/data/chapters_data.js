    ...
    "exams": [
      {
        ...
        "questions": [
          {
            "num": 1,
            "title": "Case Study & Usability Goals",
            "marks": 20,
      ...
      },
      {
        ...
        "questions": [
          {
            "num": 1,
            "title": "Interaction Design Foundations",
            "marks": 15,
            "description": "1.1 Explain what is meant by Interaction Design and how it relates to User Experience. (5 Marks)  \n1.2 Differentiate between **Accessibility** and **Inclusiveness**, and provide one example of each. (5 Marks)  \n1.3 Why should designers have a better understanding of people in the contexts in which they live, work, and learn? (5 Marks)",
            "section": "A",
            "solution": "Interaction Design Foundations\n* **1.1 Interaction Design & UX**:\n  * **Interaction Design** is designing interactive products to support the way people communicate and interact in their everyday and working lives. (2)\n  * **User Experience** refers to how a product behaves and is used by people in the real world—how they feel about it, their satisfaction, pleasure, etc. (2)\n  * Interaction Design is the activity, while User Experience is the outcome. Designers design *for* a good user experience. (1)\n* **1.2 Accessibility vs Inclusiveness**:\n  * **Accessibility** is the extent to which an interactive product is usable by as many people as possible, particularly disabled people (e.g., screen readers for blind users). (2.5)\n  * **Inclusiveness** is making products accommodate the widest possible range of people regardless of disability, education, age, or income (e.g., designing an app that works on low-end smartphones with slow internet). (2.5)\n* **1.3 Understanding Context**:\n  * It helps designers avoid designing systems based on their own biases. By understanding the context (where, how, and who will use the system), they can design products that match users' actual needs, capabilities, and cognitive constraints. (5)"
          },
          {
            "num": 2,
            "title": "User-Centered Design Principles",
            "marks": 15,
            "description": "2.1 John Gould and Clayton Lewis (1985) proposed three principles of user-centered design. List these principles and explain what activities each principle entails. (9 Marks)  \n2.2 Explain the difference between **Formative** and **Summative** evaluation in user-centered design. (6 Marks)",
            "section": "A",
            "solution": "User-Centered Design Principles\n* **2.1 Gould and Lewis Principles (3 Marks each)**:\n  * *Early focus on users and tasks*: Observing users, studying the tasks they perform, and involving them directly in the design process from the start.\n  * *Empirical measurement*: Using simulations, paper prototypes, and manuals early in development to measure user reaction and performance.\n  * *Iterative design*: A cycle of design-test-modify, where usability problems are fixed and re-tested.\n* **2.2 Formative vs. Summative Evaluation**:\n  * **Formative evaluation** is conducted during design and prototyping to shape and improve the interface. (3)\n  * **Summative evaluation** is conducted at the end of development to measure the final system's success, speed, and user satisfaction. (3)"
          },
          {
            "num": 3,
            "title": "Evaluation & Inspections",
            "marks": 20,
            "description": "3.1 Heuristic evaluation is a popular usability inspection method. Outline the **three stages** of heuristic evaluation. (6 Marks)  \n3.2 Nielsen's usability heuristics are widely used in interface evaluation. List and explain four of these heuristics. (8 Marks)  \n3.3 What is a **Cognitive Walkthrough**? State the main focus and list two questions evaluators ask during a cognitive walkthrough. (6 Marks)\n\n---\n---",
            "section": "A",
            "solution": "Evaluation & Inspections\n* **3.1 Three Stages of Heuristic Evaluation (2 Marks each)**:\n  * *Briefing*: Evaluators are told the goals, target users, and tasks to focus on.\n  * *Evaluation Period*: Each expert independently inspects the system (taking at least two passes) against usability heuristics.\n  * *Debriefing*: Experts meet to aggregate their findings, prioritize usability issues, and suggest fixes.\n* **3.2 Nielsen's Heuristics (Any four, 2 Marks each)**:\n  * *Visibility of system status*: The system should keep users informed of what is going on through timely feedback.\n  * *Match between system and real world*: Speak the user's language with familiar words and concepts.\n  * *User control and freedom*: Provide \"emergency exits\" to leave unwanted states, support undo/redo.\n  * *Consistency and standards*: Follow conventions so users don't wonder if different words mean the same thing.\n  * *Error prevention*: Design interfaces to prevent errors before they occur.\n  * *Recognition rather than recall*: Make objects and options visible to reduce memory load.\n  * *Flexibility and efficiency*: Accelerators to help expert users complete tasks quickly.\n  * *Aesthetic and minimalist design*: Omit irrelevant information.\n  * *Help users recover from errors*: Error messages should be plain, precise, and constructive.\n  * *Help and documentation*: Searchable, task-focused documentation.\n* **3.3 Cognitive Walkthrough**:\n  * *Definition & Focus*: A usability inspection method simulating user problem-solving at each step. It focuses on evaluating the design for **ease of learning**. (3)\n  * *Questions (Any two, 1.5 Marks each)*:\n    * Will the correct action be sufficiently evident to the user?\n    * Will the user notice that the correct action is available?\n    * Will the user associate and interpret the response from the action correctly?"
          }
        ],
        "id": "spu_main_2025"
      },
      {
        ...
        "questions": [
          {
            "num": 1,
            "title": "Designing for Sensual Experience",
            "marks": 15,
            "description": "A company wants to design a luxury online tutoring portal that evokes a sense of \"exclusivity\", \"professionalism\", and \"calmness\".\n\n1.1 Explain what is meant by a **sensual experience** in interaction design. (5 Marks)  \n1.2 Explain why a designer cannot directly design the experience itself. (4 Marks)  \n1.3 Propose two concrete design features (using visual, auditory, or interaction cues) that would evoke a sensual experience of \"professionalism\" and \"calmness\" for students. (6 Marks)",
            "section": "A",
            "solution": "Designing for Sensual Experience\n* **1.1 Sensual Experience**:\n  * A sensual experience refers to the way people perceive and interact with a product, system, or environment through their senses—sight, sound, touch, taste, and smell. (5)\n* **1.2 Subjective Constraint**:\n  * Experiences are subjective, internal, and depend on the user's emotional state, personal history, memories, and immediate context. Therefore, designers cannot program or force a specific experience; they can only design physical features that increase the likelihood of evoking that experience. (4)\n* **1.3 Proposed Features (3 Marks each)**:\n  * *Visual Design (for Calmness)*: Use a clean, minimalist layout with a soothing, harmonious color palette (e.g., soft blues, warm grays) and ample white space to reduce visual clutter and cognitive overload.\n  * *Interaction Design (for Professionalism)*: Implement a responsive, lag-free navigation bar with smooth micro-animations on hover, giving clear feedback and demonstrating high-quality system engineering."
          },
          {
            "num": 2,
            "title": "Process of Interaction Design",
            "marks": 15,
            "description": "2.1 List and explain the **four basic activities** of the interaction design process. (8 Marks)  \n2.2 Explain why evaluation is integrated throughout the interaction design lifecycle rather than being a single phase at the end. (7 Marks)",
            "section": "A",
            "solution": "Process of Interaction Design\n* **2.1 Four Basic Activities (2 Marks each)**:\n  * *Establishing Requirements*: Discovering user needs, capabilities, and system constraints.\n  * *Designing Alternatives*: Generating potential conceptual models and interface designs.\n  * *Prototyping*: Creating interactive mockups to explore and test design ideas.\n  * *Evaluating*: Testing the interface with users or experts to check usability.\n* **2.2 Integrated Evaluation**:\n  * If evaluation is left until the end, finding major conceptual or design flaws would require rewriting massive amounts of code, which is expensive and slow. Integrating evaluation at each step (e.g., evaluating wireframes, then interactive mockups, then code) allows errors to be caught early when they are cheap to fix, ensuring the system remains user-centric. (7)"
          },
          {
            "num": 3,
            "title": "Evaluation in Natural Settings",
            "marks": 20,
            "description": "3.1 Define what a **field study** is and state which type of evaluation setting it belongs to. (4 Marks)  \n3.2 State three advantages and two disadvantages of conducting evaluations in natural settings (field studies) compared to controlled laboratory settings. (10 Marks)  \n3.3 Why is 5 to 12 users considered an acceptable participant size for usability testing? (6 Marks)\n\n---\n---",
            "section": "A",
            "solution": "Evaluation in Natural Settings\n* **3.1 Field Study**:\n  * A field study is a method of evaluating how a product is used by people in their normal, day-to-day settings (natural environments) with little or no intervention from evaluators. (4)\n* **3.2 Field Studies vs. Lab Settings**:\n  * *Advantages (Any three, 2 Marks each)*:\n    * High ecological validity: Shows how the product is used in real-world contexts.\n    * Uncovers unexpected usage patterns, workarounds, or environmental distractions.\n    * Captures long-term user habits and emotional adoption.\n  * *Disadvantages (Any two, 2 Marks each)*:\n    * Evaluators have little to no control over user activities or external distractions.\n    * Difficult to replicate test conditions or capture precise quantitative performance logs.\n* **3.3 Participant Size**:\n  * Jakob Nielsen's empirical research showed that testing with 5 users uncovers about 85% of usability issues. Adding more users yields diminishing returns, as they tend to repeat the same errors. Hence, 5 to 12 users is the most cost-effective range for usability tests. (6)"
          }
        ],
        "id": "practice_exam_3"
      }
